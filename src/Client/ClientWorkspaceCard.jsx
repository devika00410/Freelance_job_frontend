...
const ClientWorkspaceCard = ({ workspace }) => {
  ...
  const handleClick = (e) => {
    ...
    const workspaceId = workspace._id || workspace.workspaceId || workspace.id;
    ...
    console.log('Navigating to workspace ID:', workspaceId);
    navigate(`/client/workspace/${workspaceId}`);
  };

  // Helper functions
  const getDisplayTitle = () => {
    return workspace.title || workspace.projectTitle || 'Untitled Project';
  };
  ...
  const getBudget = () => {
    const budget = workspace.budget || workspace.totalBudget || 0;
    return budget.toLocaleString();
  };

  const getProgress = () => {
    return workspace.progress || workspace.overallProgress || 0;
  };
  ...
  const getMilestoneCount = () => {
    return workspace.milestones || workspace.milestoneCount || 0;
  };
  ...
  const getFreelancerRating = () => {
    return workspace.freelancerRating || workspace.freelancer?.rating || '4.5';
  };

  const getDaysLeft = () => {
    if (workspace.daysLeft !== undefined) return workspace.daysLeft;
    if (workspace.endDate) {
  ...
  return (
    <div 
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 8px 25px rgba(66, 153, 225, 0.15)';
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{
              ...
              <span style={{
                ...
                <span>ID: {workspace.workspaceId || 'N/A'}</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = 'linear-gradient(90deg, #3182ce 0%, #2c5282 100%)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.background = 'linear-gradient(90deg, #4299e1 0%, #3182ce 100%)';
          }}
        >
