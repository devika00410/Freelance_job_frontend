// Homepage About Snippet (AboutSnippet.jsx)
import React from "react";
import { FaArrowRight } from "react-icons/fa";
import "./About.css";
import aboutImg from "../assets/about-preview.png"; // Replace with your image
  ...
  return (
    <section className="about-snippet">
      ...
      <div className="snippet-image">
        <img src={aboutImg} alt="About Preview" />
      </div>
    </section>
  );
};

// Full About Page (About.jsx)
import React from "react";
import {
  FaUsers,
  FaTasks,
...
import "./About.css";
import aboutBanner from "../assets/about-banner.png"; // Replace
import aboutWork from "../assets/about-work.png"; // Replace
